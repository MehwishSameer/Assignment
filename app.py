...
if keyword:
    ...
    if keyword.lower() in st.session_state.extracted_text.lower():
        ...
        # Replace the keyword with a highlighted version using HTML
        highlighted_text = re.sub(f"({escaped_keyword})", r'<mark>\1</mark>', st.session_state.extracted_text, flags=re.IGNORECASE)
